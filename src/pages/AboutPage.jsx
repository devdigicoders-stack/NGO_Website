...
const AboutPage = () => {
  ...
  const cells = [
    ...
    { 
      name: 'प्रेस एवं मीडिया प्रकोष्ठ', 
      img: '/ID/press.png', 
    ...
    { 
      name: 'अखिल भारतीय सेवा प्रकोष्ठ', 
      img: '/ID/akhil.png', 
